...
public class Server implements Runnable
{
    ...
    public final Object hashLock = new Object();
    //
...
//			this.server = server;
		...
		public void run()
		{
			...
			while ((command = (Command) serializer.readFromSocket()) != null)
			{
				...
				//	System.out.println("inside verifying");
					backup(command);
...
//        }
	...
	public void run()
	{
		makePrimary(GroupManager.getInstance().proxyIP);
		//connectToMaster();
